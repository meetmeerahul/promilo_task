...
import 'package:promilo_task/screens/bottom_nav/bottomnav_screen.dart';
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: const TextUnderTextBox(text: "Sign In WIth OTP"),
                      ),
                      const Padding(
                        padding: EdgeInsets.fromLTRB(15, 8, 8, 2),
                          ...
                          child: TextFormField(
                            ...
                            decoration: InputDecoration(
                              errorText: passwordTapped &&
                                  ...
                                  : null,
                              labelText: passwordTapped ? "" : "Enter Password",
                              border:
                                  InputBorder.none, // Remove the default border
                              contentPadding:
                                  const EdgeInsets.symmetric(horizontal: 10.0),
                      ...
                      Row(
                        children: [
                          ...
                          Padding(
                            ...
                            child:
                                const TextUnderTextBox(text: "Forget Password"),
                          ),
                        ],
                      ),
